...

{
	...
	*/
...

	{
		...
		$this->crumbsTitle=Yii::t("default","Add City");

			if (isset($_GET['Do'])){

			//$this->crumbsTitle=Yii::t("default","Voucher Add/Update");

			$this->render('city-add');

		} else $this->render('city');	
		
		

	}
	
	public function actionRmbrate()

	{

		$this->crumbsTitle=Yii::t("default","RMB Rate");

		$this->render('rmb-rate');
